...
async function sendMessage(phone: string, message: string, mediaId?: string, mediaType?: string, file?: File): Promise<void> {
    const payload: any = {
    ...
    try {
        ...
        if (file) {
            ...
            if (mimeType.startsWith("image/")) {
                ...
                mediaType = "audio";
            } else if (mimeType === "application/pdf" || mimeType==="text/csv" ||
